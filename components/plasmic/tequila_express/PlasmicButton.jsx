...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 4EG1uUDBEib2/css
import CheckSvgIcon from "./icons/PlasmicIcon__CheckSvg"; // plasmic-import: aMp-_KpuhKzH/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: Qq4h6xXgNmFh/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__lsEpj)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__j87Si)}
                role={"img"}
              />
            ),
